...
clear
echo -e "${BICyan} ┌─────────────────────────────────────────────────────────┐${NC}"
echo -e "                     ${BIWhite}${UWhite}SYTEM INFORMATION ${NC}"
echo -e " ${BICyan}└─────────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────────┐${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}Hostname    :${NC} $HOSTNAME      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}OS Name     :${NC} $Tipe      "
# echo -e "Processor   : $tipeprosesor"
# echo -e "Proc Core   :$totalcore"
# echo -e "Virtual     :$typevps"
# echo -e "Cpu Usage   :$cpu_usage"
echo -e "     ${BIWhite}»${NC} ${BICyan}Total RAM   :${NC} ${totalram}MB      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}Public IP   :${NC} $MYIP      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}Domain      :${NC} $Domen      ${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────────┘${NC}"
echo""
echo -e "${BICyan} ┌─────────────────────────────────────────────────────────┐${NC}"
echo -e "                     ${BIWhite}${UWhite}SERVICE INFORMATION ${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────────┐${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}SSH / TUN               :${NC} $status_ssh      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}OpenVPN                 :${NC} $status_openvpn      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}Dropbear                :${NC} $status_beruangjatuh      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}Stunnel4                :${NC} $status_stunnel      ${NC}"
#echo -e "     ${BIWhite}»${NC} ${BICyan}Squid                   :${NC} $status_squid      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}Fail2Ban                :${NC} $status_fail2ban      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}Crons                   :${NC} $status_cron      ${NC}"
#echo -e "     ${BIWhite}»${NC} ${BICyan}Vnstat                  :${NC} $status_vnstat      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}XRAYS Vmess TLS         :${NC} $status_tls_v2ray      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}XRAYS Vmess None TLS    :${NC} $status_nontls_v2ray      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}XRAYS Vless TLS         :${NC} $status_tls_vless      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}XRAYS Vless None TLS    :${NC} $status_nontls_vless      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}XRAYS Trojan            :${NC} $status_virus_trojan      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}Trojan GO               :${NC} $status_trgo      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}Websocket TLS           :${NC} $swstls      ${NC}"
echo -e "     ${BIWhite}»${NC} ${BICyan}Websocket None TLS      :${NC} $swsdrop      ${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────────┘${NC}"
